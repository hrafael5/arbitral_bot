...
class ArbitrageEngine {
    ...
    // Filtra oportunidades com lucro líquido menor ou igual a 0.5%
    if (details.netSpreadPercentage <= 0.5) {
        return; // Ignora a oportunidade e não a envia
    }
        // --- FIM DA CORREÇÃO ---
        ...
        const opportunity = {
            ...
            // timestamp: details.now, // Linha removida
        };
