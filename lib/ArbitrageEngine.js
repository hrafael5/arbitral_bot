...
class ArbitrageEngine {
    ...
    signalOpportunity(details) {
        // --- INÍCIO DA ALTERAÇÃO ---
        // A checagem de lucro mínimo global foi REMOVIDA daqui.
        // O frontend agora é responsável por filtrar as oportunidades com base na visualização (Arbitragens, Saída OP, etc).
        // A verificação de `netSpreadPercentage < this.minProfitPercentage` foi removida.
        // --- FIM DA ALTERAÇÃO ---
        ...
        if (!isSpotToFutures && !(isFuturesToFutures && futuresVsFuturesStrategyIsEnabled) && !(isSpotToSpot && spotVsSpotStrategyIsEnabled)) {
            return;
        }
