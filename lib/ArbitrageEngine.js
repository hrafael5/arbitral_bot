...
class ArbitrageEngine {
    ...
    signalOpportunity(details) {
        // CORREÇÃO APLICADA: Bloco 'if (details.netSpreadPercentage <= 0.5)' removido para
        // garantir que todas as oportunidades sejam enviadas ao frontend para filtragem local.
